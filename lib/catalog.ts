...
export const products: Product[] = [
  {
    ...
    sku: 'TK-SVP-001',
    image: '/images/products/schema-validator.svg',
    images: ['/images/products/schema-validator.svg'],
  ...
  },
  {
    ...
    availability: 'InStock',
    sku: 'TK-ASG-002',
    image: '/images/products/answer-studio.svg',
    images: ['/images/products/answer-studio.svg'],
  ...
  },
  {
    ...
    availability: 'InStock',
    sku: 'TK-CIS-003',
    image: '/images/products/crawl-insight.svg',
    images: ['/images/products/crawl-insight.svg'],
